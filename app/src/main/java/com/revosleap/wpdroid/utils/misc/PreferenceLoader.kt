...
class PreferenceLoader(private val context: Context) {
    ...
    var url = manager.getString(context.getString(R.string.app_sites), "tecmint.com")
        set(value) = manager.edit().putString(context.getString(R.string.app_sites), value).apply()
